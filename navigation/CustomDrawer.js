    ...
    >
      ...
      >
        ...
        <Drawer.Screen name="workshops">
          {(props) => (
            <Workshops {...props} drawerAnimationStyle={animatedStyle} />
          )}
        </Drawer.Screen>
        <Drawer.Screen name="speakers">
          {(props) => (
            <Speakers {...props} drawerAnimationStyle={animatedStyle} />
          )}
        </Drawer.Screen>
        ...
        <Drawer.Screen name="News">
          {(props) => <News {...props} drawerAnimationStyle={animatedStyle} />}
        </Drawer.Screen>
